      ...
      <body>
        <div class="container">
          ...
          <div class="content">
            ...
            <p>Your prescription from <strong>Dr. ${data.doctorName}</strong> has been issued and recorded on the blockchain.</p>
            ...
            <div class="prescription-details">
              ...
              <p><strong>Security:</strong> ✅ Secured on blockchain</p>
            </div>
          ...
          <div class="footer">
            <p>This prescription is secured on the Hedera blockchain and cannot be tampered with.</p>
